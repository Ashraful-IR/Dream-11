...
const Hero = () => {
  return (
    <div className='bg-[url("/src/assets/bg-shadow.png")] bg-cover bg-center w-full h-full flex items-center justify-center bg-[#131313] flex-col gap-10 p-10 rounded-lg'>
